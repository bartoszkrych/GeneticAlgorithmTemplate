...
template<> double CKnapsackProblem<bool>::dGetValueFromGen(bool* piTable)
{
...
template<> double CKnapsackProblem<int>::dGetValueFromGen(int* piTable)
{
	double d_value_gen = 0.0;
	for (int i = 0; i < i_items_count; i++)
	{
...
template<> double CKnapsackProblem<double>::dGetValueFromGen(double* piTable)
{
	double d_value_gen = 0.0;
	for (int i = 0; i < i_items_count; i++)
	{
...
template<> double CKnapsackProblem<bool>::dGetSizeFromGen(bool* piTable)
{
...
template<> double CKnapsackProblem<int>::dGetSizeFromGen(int* piTable)
{
	double d_size_gen = 0.0;
	for (int i = 0; i < i_items_count; i++)
	{
...
template<> double CKnapsackProblem<double>::dGetSizeFromGen(double* piTable)
{
	double d_size_gen = 0.0;
	for (int i = 0; i < i_items_count; i++)
	{
